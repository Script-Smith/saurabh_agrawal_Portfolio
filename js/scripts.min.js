function initMap() {
  var t = new google.maps.LatLng(48.859003, 2.345275),
    e = {
      zoom: 16,
      center: t,
      mapTypeControl: !1,
  ...
  new google.maps.marker.AdvancedMarkerElement({ position: t, map: n, title: "We are here!" });
}
!(function (t, e) {
  "use strict";
  ...
  var x = (function (n) {
    ...
    return (
      ...
      (h.sortStable = S.split("").sort(O).join("") === S),
  ...
  S.ajaxSetup({
    ...
    (g.createHTMLDocument =
      (((qe = T.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
              ...
              if (0 < n.length) {
                ...
                "replaceWith" === i
                  ...
                  ? n.is("img")
                    ? n.attr("src", e)
                    : n.replaceWith(
                        c("<img>").attr("src", e).attr("class", n.attr("class"))
                      )
                  : n.attr(o[1], e);
              }
          ...
          if ((_(), t.src)) {
            ...
            if (i.length) {
              ...
              r &&
                ...
                (S = i.after(T).detach().removeClass(E))),
        ...
        getImage: function (t, e) {
          ...
          if (s.length) {
            ...
            (a.className = "mfp-img"),
              ...
              (t.img = c(a).on("load.mfploader", i).on("error.mfploader", r)),
              (a.src = t.src),
                      ...
                      (r =
                        "x" === o
                          ...
                          : ((t = this.trackY),
                            (e = this.scrollbarY),
                            (n =
                              this.scrollContentEl[this.scrollOffsetAttr[o]]),
                            (i = this.contentSizeY),
